...
class Population
{
    protected:
        ...
        std::int32_t NY;
        std::int32_t NZ;
        AaPattern<LT,T,NPOP> aa_pattern;
    ...
    public:
        ...
        */
        Population(std::int32_t const NX, std::int32_t const NY, std::int32_t const NZ) noexcept
            : NX{NX}, NY{NY}, NZ{NZ}, aa_pattern{AaPattern<LT,T,NPOP>{NX,NY,NZ}}
        {
            static_assert( (LT<T>::DIM == 2) ? (NZ == 1) : true, "Two-dimensional lattice with NZ != 1." );

            std::int64_t const memorySize = sizeof(T)*NZ*NY*NX*NPOP*static_cast<std::int64_t>(LT<T>::ND);

            /// pointer to population
            #ifdef _WIN32
            A = static_cast<T*>(_aligned_malloc(static_cast<std::size_t>(memorySize), CACHE_LINE));
            #else
            A = static_cast<T*>(std::aligned_alloc(CACHE_LINE, static_cast<std::size_t>(memorySize)));
            #endif
        ...
        */
        ...
        {
            return aa_pattern.template indexRead<TS>(x,y,z,n,d,p);
        }
        ...
        */
        ...
        static inline std::int64_t indexWrite(std::array<std::int32_t,3> const &x, 
                                              ...
                                              std::int32_t               const p = 0) noexcept
        {
            return aa_pattern.template indexWrite<TS>(x,y,z,n,d,p);
        }
        ...
        */
        template <timestep TS>
        inline auto&      read(std::array<std::int32_t,3> const &x,
                               std::array<std::int32_t,3> const &y,
                               std::array<std::int32_t,3> const &z,
                               std::int32_t               const n,
                               std::int32_t               const d,
        ...
        template <timestep TS>
        inline auto const& read(std::array<std::int32_t,3> const &x,
                                std::array<std::int32_t,3> const &y,
                                std::array<std::int32_t,3> const &z,
                                std::int32_t               const n,
                                std::int32_t               const d,
        ...
        */
        template <timestep TS>
        inline auto&       write(std::array<std::int32_t,3> const &x, 
                                 std::array<std::int32_t,3> const &y,
                                 std::array<std::int32_t,3> const &z,
                                 std::int32_t               const n,
                                 std::int32_t               const d,
        ...
        template <timestep TS>
        inline auto const& write(std::array<std::int32_t,3> const &x,
                                                                std::array<std::int32_t,3> const &y,
                                                                std::array<std::int32_t,3> const &z,
                                                                std::int32_t               const n,
                                                                std::int32_t               const d,
