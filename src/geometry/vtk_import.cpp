  ...
  */
  class Importer {
    public:
      ...
      */
      static vtkSmartPointer<vtkImageData> newImageData(int const resolution_x, std::array<double, 6> const& bounding_box) noexcept;
  ...
  vtkSmartPointer<vtkImageData> Importer::newImageData(int const resolution_x, std::array<double, 6> const& bounding_box) noexcept {
    ...
    image_data->GetPointData()->GetScalars()->Fill(Importer::background_colour);
