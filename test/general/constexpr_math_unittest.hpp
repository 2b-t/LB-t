...
TYPED_TEST(SqrtTest, randomNumberSquaredCorrectSqrt) {
  ...
  int const exponent {lbt::test::generateRandomNumber(0, exponent_max)};
  TypeParam const mantissa {lbt::test::generateRandomNumber(static_cast<TypeParam>(0), mantissa_max)};
