  ...
  namespace test {
    ...
    */
    ...
    constexpr bool isSymmetric(lbt::StackArray<T,N> const& arr) noexcept {
      ...
      is_symmetric &= lbt::cem::isNearlyEqualEpsAbs(arr.at(0), arr.at(hspeed));
      for (std::size_t i = 1; i < hspeed; ++i) {
        is_symmetric &= lbt::cem::isNearlyEqualEpsAbs(arr.at(i), arr.at(i + hspeed));
      }
      return is_symmetric;
    }
    ...
    */
    ...
    constexpr bool isAntimetric(lbt::StackArray<T,N> const& arr) noexcept {
      ...
      is_antimetric &= lbt::cem::isNearlyEqualEpsAbs(arr.at(0), arr.at(hspeed));
      for (std::size_t i = 1; i < hspeed; ++i) {
        is_antimetric &= lbt::cem::isNearlyEqualEpsAbs(arr.at(i), -arr.at(i + hspeed));
      }
    ...
    */
    ...
    constexpr bool sumsTo(lbt::StackArray<T,N> const& arr, T const expected_sum) noexcept {
      ...
      return lbt::cem::isNearlyEqualEpsAbs(sum, expected_sum);
    }
